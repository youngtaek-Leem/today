...
| FR2 | 사진 촬영: 카메라 직접 촬영 + 갤러리 선택 지원, 저장 1회당 최대 20장 | P0 |
| FR3 | 텍스트 메모: 작성 및 수정 가능 | P0 |
| FR4 | 녹음/사진 교체·삭제 가능, 사진은 추가 및 순서 변경 가능 | P0 |
...
| FR15 | 사진 순서 드래그 변경 (상세 화면 핸들), 스토리 [사진n] 자동 배치·칩 탭 삽입·칩 순서 변경 | P0 |
...
| 2026-09-10 | FR15 추가: 사진 드래그 순서 변경, 스토리 [사진n] 자동 배치·드래그 배치 | 사용성 개선 요청 |